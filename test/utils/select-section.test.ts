...
describe('selectSection', () => {
  ...
  test('returns correct variant from single element set', () => {
    ...
    expect(selectSection(variants1, 0, 0, 5)?.physicalPageIndex).toBe(11);
    expect(
      selectSection(variants1, 1, 0, 5)?.physicalPageIndex
    ).toBeUndefined();
    expect(
      selectSection(variants1, 2, 0, 5)?.physicalPageIndex
    ).toBeUndefined();
    expect(
      selectSection(variants1, 3, 0, 5)?.physicalPageIndex
    ).toBeUndefined();
    expect(
      selectSection(variants1, 4, 0, 5)?.physicalPageIndex
    ).toBeUndefined();

    expect(
      selectSection(variants2, 0, 5, 5)?.physicalPageIndex
    ).toBeUndefined();
    expect(
      selectSection(variants2, 1, 5, 5)?.physicalPageIndex
    ).toBeUndefined();
    expect(
      selectSection(variants2, 2, 5, 5)?.physicalPageIndex
    ).toBeUndefined();
    expect(
      selectSection(variants2, 3, 5, 5)?.physicalPageIndex
    ).toBeUndefined();
    expect(selectSection(variants2, 4, 5, 5)?.physicalPageIndex).toBe(21);

    expect(
      selectSection(variants3, 0, 10, 5)?.physicalPageIndex
    ).toBeUndefined();
    expect(selectSection(variants3, 1, 10, 5)?.physicalPageIndex).toBe(31);
    expect(
      selectSection(variants3, 2, 10, 5)?.physicalPageIndex
    ).toBeUndefined();
    expect(selectSection(variants3, 3, 10, 5)?.physicalPageIndex).toBe(31);
    expect(
      selectSection(variants3, 4, 10, 5)?.physicalPageIndex
    ).toBeUndefined();

    expect(
      selectSection(variants4, 0, 15, 5)?.physicalPageIndex
    ).toBeUndefined();
    expect(selectSection(variants4, 1, 15, 5)?.physicalPageIndex).toBe(41);
    expect(
      selectSection(variants4, 2, 15, 5)?.physicalPageIndex
    ).toBeUndefined();
    expect(selectSection(variants4, 3, 15, 5)?.physicalPageIndex).toBe(41);
    expect(
